...
namespace DataIngestor
{
    ...
    public static class ADTToAzureTimeSeriesFunction
    {
        ...
        public static async Task Run(
            [EventHubTrigger("tech-adt-twins-hub", Connection = "EventHubAppSettings-Twins")] EventData myEventHubMessage,
            [EventHub("tech-adt-time-series-hub", Connection = "EventHubAppSetting-TSI")] IAsyncCollector<string> outputEvents,
            ILogger log)
        {
            ...
            if (tsiUpdate.Count > 0)
            {
                ...
                log.LogInformation($"TSI Update values: {JsonConvert.SerializeObject(tsiUpdate)}");
